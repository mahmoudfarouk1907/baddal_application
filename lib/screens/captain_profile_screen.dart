...
import 'captain_support_screen.dart'; // استدعاء شاشة الدعم الفني وإرسال الإيصالات
    ...
    return Scaffold(
      ...
      body: _isLoading
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                children: [
                  CircleAvatar(radius: 50, backgroundColor: primaryGreen.withOpacity(0.1), child: const Icon(Icons.sports_motorsports_rounded, size: 60, color: primaryGreen)),
                  ...
                  // 📄 زرار الدعم الفني الجديد لرفع إيصالات التوريد كاش
                  Card(
                    elevation: 0,
                    ...
                    child: ListTile(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const CaptainSupportScreen()),
                        );
                      },
                      leading: const Icon(Icons.support_agent_rounded, color: primaryGreen),
                      title: const Text("الدعم الفني وإرسال الإيصالات", style: TextStyle(color: navyBlue, fontWeight: FontWeight.bold)),
